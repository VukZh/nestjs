...
4. Add the following **Environment Variables**:
   ...
   - `PORT`: `3000`
   - `FE_URL`: `https://nestjs-frontend-latest-653g.onrender.com` (your frontend URL).

### Step 3: Frontend Service
1. On GitHub, go to **Settings -> Secrets and variables -> Actions -> Variables**.
2. Add a variable `VITE_API_URL` with your **Backend URL** (e.g., `https://nestjs-backend-latest-96wc.onrender.com`).
